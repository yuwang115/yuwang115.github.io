...
image:
  caption: "Temperature sections from the 3-D temperature simulation along the JP flowline"
  focal_point: "Center"
  preview_only: false
...
<!-- {{< figure src="temperature.png" alt="Temperature field map" caption="Additional figure: Temperature field snapshot from the study." >}} -->